...
public class EspressoTestsUserStory6 {
    ...
    @Test
    public void espressoTestsUserStory6() {
        ...
        ViewInteraction textView2 = onView(
                allOf(withId(R.id.directions_text), withText("1. Proceed on Entrance Way 10.0 ft towards Africa Rocks Street.\n2. Proceed on Africa Rocks Street 200.0 ft towards Gorillas.\n"),
                        withParent(withParent(withId(android.R.id.content))),
                        isDisplayed()));
        textView2.check(matches(withText("1. Proceed on Entrance Way 10.0 ft towards Africa Rocks Street. 2. Proceed on Africa Rocks Street 200.0 ft towards Gorillas. ")));
