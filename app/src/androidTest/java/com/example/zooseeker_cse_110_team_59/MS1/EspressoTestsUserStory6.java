...
public class EspressoTestsUserStory6 {
    ...
    public void testDirectionsFirstOpened() {
        ...
        materialAutoCompleteTextView.perform(replaceText("Hippos"), closeSoftKeyboard());
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.place_name),
                        ...
                        isDisplayed()));
        textView.check(matches(withText("Directions to Hippos")));
        ...
        textView2.check(matches(withText("1. Proceed on Gate Path 1100.0 ft towards Treetops Way.\n" +
                ...
                "3. Proceed on Hippo Trail 1900.0 ft towards Hippos.\n")));

        ViewInteraction button = onView(
                allOf(withId(R.id.next_btn),
                        withParent(withParent(withId(android.R.id.content))),
                        isDisplayed()));
        button.check(matches(withText("NEXT: GORILLAS, 12400.0FT")));
    }
