...
public class AddToNonEmptyList {
    ...
    public void addToNonEmptyList() {
        ViewInteraction materialAutoCompleteTextView = onView(
                Matchers.allOf(ViewMatchers.withId(R.id.search_bar),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        materialAutoCompleteTextView.perform(replaceText("Baboons"), closeSoftKeyboard());
        ...
        ViewInteraction appResultText1 = onView(
                allOf(withId(R.id.animals_list_text_view), isDisplayed())).check(matches(withText("Baboons" + "\n" + "Lions" + "\n")));
