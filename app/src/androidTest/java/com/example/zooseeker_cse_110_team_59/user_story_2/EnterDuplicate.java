...
public class EnterDuplicate {
    ...
    public void enterDuplicate() {
        ViewInteraction materialAutoCompleteTextView = onView(
                Matchers.allOf(ViewMatchers.withId(R.id.search_bar),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        materialAutoCompleteTextView.perform(replaceText("Turtles"), closeSoftKeyboard());
        ...
        ViewInteraction appResultText1 = onView(
                allOf(withId(R.id.animals_list_text_view), isDisplayed())).check(matches(withText("Turtles" + "\n")));
        ...
        ViewInteraction materialAutoCompleteTextView2 = onView(
                allOf(withId(R.id.search_bar),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        materialAutoCompleteTextView2.perform(replaceText("Turtles"), closeSoftKeyboard());
